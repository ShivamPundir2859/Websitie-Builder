...
const LoaderSteps = () => {
    ...
    return (
        ...
        relative overflow-hidded text-white'>
            ...
            transitio-all duration-700 ease-in-out opacity-100'> {steps[current].label}</p>
