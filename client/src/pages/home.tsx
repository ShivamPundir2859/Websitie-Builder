      ...
      <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
        ...
        <a href="/" className="flex items-center gap-2 border border-slate-700 rounded-full p-1 pr-3 text-sm mt-20">
          ...
          <p className="flex items-center gap-2">
            ...
            <svg className="mt-px" width="6" height="9" viewBox="0 0 6 9" fill="none" xmlns="/"><path d="m1 1 4 3.5L1 8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
          </p>
        </a>
