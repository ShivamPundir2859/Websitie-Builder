      ...
      <div className='px-4 md:px-16 lg:px-24 xl-px-32'>
        {loading ? (
              ...
              {projects.map((project) => (
                ...
                hover:border-indigo-800/80 transition-all duration-300'>
                  ...
                  <div className='p-4 text-white bg-gradient-to-b
                    ...
                    to-trnasparent transition-colors'>
                    ...
                    <div className='flex justify-between items-center mt-6'>
                      <span>{new Date(project.createdAt).
          ...
          <div className='flex flex-col items-center justify-center h-[80vh]'>
            <h1 className='text-3xl font-semibold text-gray-300'>Project Yet!</h1>
            <button onClick={() => navigate('/')} className='text-white px-5 py-2 mt-5 rounded-md
            bg-indigo-500 hover:bg-indigo-600 active-scale-95 transtion-all'>
              Create New
            </button>
          </div>
        )}
