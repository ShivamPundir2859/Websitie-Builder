...
const EditorPanel = ({ selectedElement, onUpdate, onClose }: EditorPanelProps) => {
    ...
    return (
        ...
        border-gray-200 p-4 z-50 animate-fade-in fade-in slide-in-from-right-5'>
            ...
            <div className="space-y-4 text-black">
                <div>
                    ...
                    <textarea value={values.text} onChange={(e) => handleChange('text', e.target.value)}
                        className="w-full text-sm p-2 border border-gray-400 rounded-md focus:ring-2 focus:ring-indigo-500 
